    ...
    SignupThree(String formno)//CONSTRUCTOR
    {
        ...
        add(type);
            ...
            add(pin);
                ...
                JLabel pindetails = new JLabel("(4 digit pin)");
...
//            add(c6);
            ...
            cancel.setBounds(490,720,100,30);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()== submit)
        {
            ...
            String cardnumber = " " + Math.abs((random.nextLong() % 90000000L) + 5040936000000000L);//50409360 IS THE FIXED NUMBER THAT WILL BE PRESENT AT THE BEGINNING OF THE CARD OF THE CARD NUMBER
