...
public class SignupOne extends JFrame implements ActionListener{
    ...
    public SignupOne()//constructor
    {
        ...
        add(dob);
            ...
            dateChooser = new JDateChooser();//DOWNLOADED A CALENDER JAR FILE WHICH IS LATER IMPORTED USING THE PACKAGE
    ...
    {
        String formno = " "+random;//ITS A LONG VALUE, THAT HAS TO BE CONVERTED INTO A STRING
